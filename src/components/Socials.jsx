...
const Socials = ({setShowMap}) => {
  return (
    <StyledWrapper>
      <div className="main">
        <div className="card">
          <a href="https://www.instagram.com/axellerosh_21/" target="_blank">
            <svg
              fillRule="nonzero"
              height="30px"
              width="30px"
        ...
        <div className="card">
          <a
            href="https://www.linkedin.com/in/axellerosh-lubi/"
            target="_blank"
          >
            <svg viewBox="0 0 448 512" class="dribble" height={30} width={30}>
        ...
        >
          <div className="letter">
            <img src={map} className="w-8" alt="location" />
          </div>
        </div>
        <div className="card">
        ...
        <div className="card">
          <a href="https://github.com/AXODUS21" target="_blank">
            <svg
              height="30px"
              width="30px"
              viewBox="0 0 30 30"
        ...
        <div className="card">
          <a href="https://www.facebook.com/axellerosh.lubi.9" target="_blank">
            <svg
              viewBox="0 0 16 16"
              fill="currentColor"
              id="facebook"
        ...
        <p className="text w-fit">SOCIALS</p>
